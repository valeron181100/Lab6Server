package val.bond.applogic.Clothes;

import val.bond.applogic.NetStuff.DataBaseWorks.DBConst;
import val.bond.applogic.NetStuff.DataBaseWorks.iQuery;
...
public class DownClothes extends Clothes implements Serializable, iQuery {
    ...
    public boolean equals(Object obj) {
        ...
        if (diametr_leg_sm != other.getDiametr_leg_sm())
            return false;
        ////val.bond.applogic.Clothes' Fields
